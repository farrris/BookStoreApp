...
CREATE TABLE `account_entity` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKber3tx7rd1na8or8hn93dyw70` (`user_id`),
  CONSTRAINT `FKber3tx7rd1na8or8hn93dyw70` FOREIGN KEY (`user_id`) REFERENCES `user_entity` (`id`)
...
INSERT INTO `account_entity` VALUES (1,99999,1),(2,3100,2),(3,4900,3);
